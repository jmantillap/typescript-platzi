...
class Picture {
    ...
    toString() {
        return `[id: ${__classPrivateFieldGet(this, _Picture_id, "f")}, title: ${__classPrivateFieldGet(this, _Picture_title, "f")}, orientatio : ${__classPrivateFieldGet(this, _Picture_orientation, "f")} ]`;
    }
}
